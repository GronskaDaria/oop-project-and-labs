...
//            if (!pozycja.equals(new Punkt(-1, -1))) {
...
//        }
    ...
    public void WykonajTure() {
        if (organizmy.size() >= sizeX * sizeY) {
            Komentator.DodajKomentarz("Gra zakończona. Wybierz 'Nowa Gra' z menu.");
            return;
        }
        numerTury++;
    ...
    private void SortujOrganizmy() {
        Collections.sort(organizmy, (Organizm o1, Organizm o2) -> {
    ...
    public void UsunOrganizm(Organizm organizm) {
        ...
        if (organizm.getTypOrganizmu() == Organizm.TypOrganizmu.CZLOWIEK) {
            ...
            czlowiek = null;
            setCzyJestKoniecGry(true); 
            Komentator.DodajKomentarz("--- KONIEC GRY! Twój bohater zginął. ---");
        }
    }
