...
public abstract class Organizm {
    ...
    public boolean SpecjalnaKolizja(Organizm atakujacy, Organizm ofiara) {
        return false;
    }

    public String OrganizmToString() {
        return (TypOrganizmuToString() + " ("+ pozycja.getX() + ", "+
    ...
    public Punkt LosujPoleNiezajete(Punkt pozycja) {
        ...
        if (pozX == 0) ZablokujKierunek(Kierunek.LEWO);
            ...
            if (swiat.isPoleOccupied(new Punkt(pozX - 1, pozY)) == false) ileKierunkowMozliwych++;
        ...
        if (pozY == 0) ZablokujKierunek(Kierunek.GORA);
            ...
            if (swiat.isPoleOccupied(new Punkt(pozX, pozY - 1)) == false) ileKierunkowMozliwych++;
